...
#define GEM_HW_MANAGER_DEFINE_EXCEPTION(EXCEPTION_NAME)                  \
  namespace gem {                                                        \
    namespace hw {                                                       \
      namespace managers {                                               \
        namespace exception {                                            \
        ...
        }  /* namespace gem::hw::managers::exception */                  \
      }  /* namespace gem::hw::managers */                               \
    }  /* namespace gem::hw            */                                \
  }  /* namespace gem                */

// The gem::hw exceptions.
GEM_HW_MANAGER_DEFINE_EXCEPTION(Exception)
GEM_HW_MANAGER_DEFINE_EXCEPTION(WriteValueMismatch)
GEM_HW_MANAGER_DEFINE_EXCEPTION(ConfigurationParseProblem)
GEM_HW_MANAGER_DEFINE_EXCEPTION(ConfigurationProblem)
GEM_HW_MANAGER_DEFINE_EXCEPTION(ConfigurationValidationProblem)

GEM_HW_MANAGER_DEFINE_EXCEPTION(HardwareProblem)
GEM_HW_MANAGER_DEFINE_EXCEPTION(UninitializedDevice)

GEM_HW_MANAGER_DEFINE_EXCEPTION(RCMSNotificationError)
GEM_HW_MANAGER_DEFINE_EXCEPTION(SOAPTransitionProblem)
GEM_HW_MANAGER_DEFINE_EXCEPTION(NULLReadoutPointer)

GEM_HW_MANAGER_DEFINE_EXCEPTION(SoftwareProblem)
GEM_HW_MANAGER_DEFINE_EXCEPTION(TransitionProblem)
GEM_HW_MANAGER_DEFINE_EXCEPTION(ValueError)

GEM_HW_MANAGER_DEFINE_EXCEPTION(RPCMethodError)

GEM_HW_MANAGER_DEFINE_EXCEPTION(DeviceNameParseError)

// The gem::hw::manager alarms.
#define GEM_HW_MANAGER_DEFINE_ALARM(ALARM_NAME) GEM_HW_MANAGER_DEFINE_EXCEPTION(ALARM_NAME)

GEM_HW_MANAGER_DEFINE_ALARM(MonitoringFailureAlarm)
