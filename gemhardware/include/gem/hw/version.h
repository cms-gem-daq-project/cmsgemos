...
#define GEMHARDWARE_VERSION_MINOR 3
#define GEMHARDWARE_VERSION_PATCH 2
#define GEMHARDWARE_PREVIOUS_VERSIONS "0.0.0,0.1.0,0.2.0,0.2.1,0.2.2,0.2.3,0.3.0,0.3.1"
