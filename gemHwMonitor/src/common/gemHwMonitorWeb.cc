  ...
  throw (xgi::exception::Exception)
{
  ...
  *out << "</tr>" << std::endl;
  ...
  for (uint8_t i = 0; i < gem::hw::glib::HwGLIB::N_GTX; ++i) {
    ...
    *out << "</td>" << std::endl;
    *out << "<td>" << std::endl;
    *out << linkStatus_.GTX_TRK_Errors << std::endl;
    *out << "</td>" << std::endl;
    *out << "<td>" << std::endl;
    *out << linkStatus_.GTX_TRG_Errors << std::endl;
    *out << "</td>" << std::endl;
    *out << "<td>" << std::endl;
    *out << linkStatus_.GTX_Data_Packets << std::endl;
    *out << "</td>" << std::endl;
    *out << "<td>" << std::endl;
    *out << linkStatus_.GBT_TRK_Errors << std::endl;
    *out << "</td>" << std::endl;
    *out << "<td>" << std::endl;
    *out << linkStatus_.GBT_Data_Packets << std::endl;
    *out << "</td>" << std::endl;
    *out << "</tr>" << std::endl;
    }
  ...
  throw (xgi::exception::Exception)
{
  ...
  *out << cgicc::table() <<std::endl;;
  ...
  if (!p_ohDevice->isHwConnected()) {
    ...
    *out << "<tr>" << std::endl;
    *out << "<td>" << std::endl;
    *out << "HDMI S-bit Source" << std::endl;
    *out << "</td>" << std::endl;
    *out << "<td>" << std::endl;
    *out << static_cast<int>(p_ohDevice->getHDMISBitSource()) << std::endl;
    *out << "</td>" << std::endl;
    *out << "</tr>" << std::endl;
    // *out << cgicc::table() <<std::endl;
