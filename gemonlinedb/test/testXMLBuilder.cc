...
#define BOOST_TEST_MODULE XMLBuilder
...
XMLBuilder<VFAT3ChipConfiguration> createTestXMLBuilder()
{
    XMLBuilder<VFAT3ChipConfiguration> builder;
    ...
    XMLBuilder<VFAT3ChipConfiguration>::DataSet ds;
...
BOOST_AUTO_TEST_CASE(XMLBuilderBasic)
{
    XERCES_CPP_NAMESPACE_USE

    auto builder = createTestXMLBuilder();
...
BOOST_AUTO_TEST_CASE(XMLBuilderXsdValidation)
{
    XERCES_CPP_NAMESPACE_USE
