...
BOOST_PYTHON_MODULE(_cmsgemos_gempython) {
  ...
  bpy::class_<gem::hw::HwGenericAMC, bpy::bases<gem::hw::GEMHwDevice>,
    ...
    .def("enableZeroSuppression",            &gem::hw::HwGenericAMC::enableZeroSuppression)
    .def("disableZeroSuppression",           &gem::hw::HwGenericAMC::disableZeroSuppression)
    ...
    .def("getDAQLinkInputTimeout",           &gem::hw::HwGenericAMC::getDAQLinkInputTimeout)
  ...
  bpy::class_<gem::hw::optohybrid::HwOptoHybrid, bpy::bases<gem::hw::GEMHwDevice>,
    ...
    .def("setLoopbackSBitSource", &gem::hw::optohybrid::HwOptoHybrid::setLoopbackSBitSource)
    .def("getLoopbackSBitSource", &gem::hw::optohybrid::HwOptoHybrid::getLoopbackSBitSource)
    .def("setTriggerThrottle",    &gem::hw::optohybrid::HwOptoHybrid::setTriggerThrottle)
    .def("getTriggerThrottle",    &gem::hw::optohybrid::HwOptoHybrid::getTriggerThrottle)
    .def("setHDMISBitSource", static_cast<void (gem::hw::optohybrid::HwOptoHybrid::*)(uint32_t const)>(&gem::hw::optohybrid::HwOptoHybrid::setHDMISBitSource))
    .def("setHDMISBitSource", static_cast<void (gem::hw::optohybrid::HwOptoHybrid::*)(std::array<uint8_t,6>)>(&gem::hw::optohybrid::HwOptoHybrid::setHDMISBitSource))
    ...
    .def("getReferenceClock",     &gem::hw::optohybrid::HwOptoHybrid::getReferenceClock)
    .def("isQPLLLocked",          &gem::hw::optohybrid::HwOptoHybrid::isQPLLLocked)
    .def("isQPLLFPGAPLLLocked",   &gem::hw::optohybrid::HwOptoHybrid::isQPLLFPGAPLLLocked)
