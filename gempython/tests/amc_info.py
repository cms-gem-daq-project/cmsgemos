...
amc = getAMCObject(options.slot,options.shelf,debug=options.debug)
...
# for sfp in range(4):
#     amc.writeRegister("GEM_AMC.GEM_SYSTEM.TK_LINK_TX_POLARITY",0x0)
#     pass
...
#             continue
#         amc.writeRegister("GEM_AMC.GEM_SYSTEM.TK_LINK_TX_POLARITY",0x1)
#         pass
#     pass
...
if (options.resetCounters):
    glibCounters(amc,options.gtx,True)
    amc.writeRegister("GEM_AMC.DAQ.CONTROL.DAQ_LINK_RESET",0x1)
    amc.writeRegister("GEM_AMC.DAQ.CONTROL.DAQ_LINK_RESET",0x0)
print
